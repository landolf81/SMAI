    ...
    <div className="min-h-screen bg-base-200 pt-14">
      ...
      <div className="max-w-3xl mx-auto p-4 pb-20">
        ...
        <div className="bg-base-100 rounded-lg shadow-sm p-6 space-y-6">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">1. 수집하는 개인정보 항목</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">2. 개인정보 수집 목적</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">3. 개인정보 보유 및 이용 기간</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
              <li>회원 탈퇴 시까지</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">4. 개인정보의 제3자 제공</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">5. 개인정보의 처리 위탁</h2>
            <p className="text-base-content/60 mb-2">서비스 제공을 위해 아래와 같이 개인정보를 위탁합니다.</p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">6. 이용자의 권리</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">7. 개인정보 보호책임자</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
              <li>담당자: 정병근</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">8. 개인정보 처리방침 변경</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
