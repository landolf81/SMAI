  ...
  const faqData = [
    {
      ...
      items: [
        {
          question: '성주마이는 어떤 서비스인가요?',
          answer: '성주마이는 성주군 농업인을 위한 종합 커뮤니티 플랫폼입니다. 경락 정보 조회, 커뮤니티 소통, 중고거래, QnA 등 다양한 기능을 제공합니다.'
        },
        {
          question: '회원가입은 어떻게 하나요?',
          answer: '우측 상단의 로그인 버튼을 클릭한 후 "회원가입" 버튼을 눌러주세요. 이메일 또는 카카오 계정으로 간편하게 가입할 수 있습니다.'
        },
        {
          question: '비밀번호를 잊어버렸어요.',
          answer: '로그인 페이지에서 "비밀번호 찾기"를 클릭하시면 등록하신 이메일로 비밀번호 재설정 링크를 보내드립니다.'
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: '경락 정보는 매일 오전 10시경 업데이트됩니다. 실시간 정보를 제공하기 위해 최선을 다하고 있습니다.'
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          question: '중고거래는 어떻게 하나요?',
          answer: '사고팔고 페이지 하단의 + 버튼을 클릭하여 판매글을 작성할 수 있습니다. 거래 완료 시 "거래 완료" 상태로 변경해주세요.'
        },
        {
          question: '거래 시 주의사항이 있나요?',
          answer: '직거래를 권장하며, 안전한 장소에서 거래하시길 바랍니다. 사기 피해 예방을 위해 선입금은 절대 하지 마세요.'
        },
        {
          question: '판매글을 끌어올릴 수 있나요?',
          answer: '현재는 끌어올리기 기능을 제공하지 않습니다. 새 글 작성 시 최상단에 노출됩니다.'
        }
      ]
    },
    {
      ...
      items: [
        ...
        {
          question: '답변을 채택할 수 있나요?',
          answer: '네, 질문 작성자는 가장 도움이 된 답변을 채택할 수 있습니다. 채택된 답변은 상단에 표시됩니다.'
        },
        {
          question: '전문가 답변도 받을 수 있나요?',
          answer: '인증된 전문가 회원의 답변은 별도로 표시됩니다. 전문가 인증은 관리자 승인이 필요합니다.'
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: '설정 페이지에서 푸시 알림, 댓글 알림 등 다양한 알림 설정을 관리할 수 있습니다.'
        },
        {
    ...
    <div className="min-h-screen bg-gray-50 pt-14 pb-20">
      ...
      <div className="bg-gradient-to-r from-amber-500 to-yellow-500 text-white py-8 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-amber-50">성주마이 이용에 대한 궁금증을 해결해드립니다</p>
        </div>
      </div>
