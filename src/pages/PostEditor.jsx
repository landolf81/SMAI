          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <textarea
                ...
                className={`w-full min-h-[300px] p-4 pb-6 border rounded-xl resize-y focus:outline-none focus:ring-2 focus:ring-orange-400 bg-base-100 text-base-content placeholder:text-base-content/40 ${
