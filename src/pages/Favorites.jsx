    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-base-200">
        <div className="text-center">
          ...
          <p className="mt-4 text-base-content/60">관심 목록을 불러오는 중...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-screen-xl mx-auto p-4">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-base-content/60 mt-2">자주 확인하는 시장과 품목을 저장해두세요</p>
          </div>
              ...
              <form onSubmit={handleAddFavorite} className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-base-300 rounded-lg focus:ring-2 focus:ring-green-500"
                    required
                  >
        ...
        {favorites.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {favorites.map(fav => (
              <div key={fav.id} className="bg-base-100 rounded-lg shadow hover:shadow-lg transition-shadow">
                <div className="p-6">
          ...
          <div className="text-center py-12">
            <FavoriteIcon className="text-base-content/30 text-6xl mb-4 mx-auto" />
            <h3 className="text-xl text-base-content/50 mb-2">등록된 관심 시장이 없습니다</h3>
            <p className="text-base-content/40 mb-6">자주 확인하는 시장을 추가해보세요</p>
            <button 
              onClick={() => setShowAddForm(true)}
              className="btn btn-primary"
            >
