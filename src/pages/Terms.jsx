  ...
  return (
    <div className="min-h-screen bg-base-200 pt-14">
      ...
      <div className="max-w-3xl mx-auto p-4 pb-20">
        {/* 헤더 */}
        <div className="bg-base-100 rounded-lg shadow-sm p-4 mb-4 flex items-center">
          <button
            onClick={() => navigate(-1)}
            className="p-2 -ml-2 hover:bg-base-200 rounded-full"
          >
            <ArrowBackIcon />
          </button>
        ...
        <div className="bg-base-100 rounded-lg shadow-sm p-6 space-y-6">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제3조 (약관의 효력 및 변경)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제4조 (회원가입)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제5조 (회원의 의무)</h2>
            <p className="text-base-content/60 mb-2">회원은 다음 행위를 하여서는 안 됩니다.</p>
            <ul className="list-disc list-inside text-base-content/60 space-y-1 ml-4">
              <li>타인의 정보 도용</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제6조 (서비스의 제공 및 변경)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제7조 (게시물의 관리)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제8조 (중고거래)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제9조 (회원 탈퇴 및 자격 상실)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제10조 (면책조항)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제11조 (분쟁해결)</h2>
            <ul className="list-decimal list-inside text-base-content/60 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-base-content mb-3">제12조 (문의)</h2>
            <ul className="list-disc list-inside text-base-content/60 space-y-1">
              <li>서비스 관련 문의: landolf@naver.com</li>
            </ul>
          </section>

          <div className="pt-4 border-t text-sm text-base-content/50">
            <p>시행일: 2025년 1월 1일</p>
          </div>
        </div>
      </div>
