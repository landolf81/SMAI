...
import { commentService } from "../services/commentService";
  ...
  const Comments = ({ postId }) => {
    ...
    const mutation = useMutation({
      mutationFn: (newComment) => commentService.createComment({
              ...
              {isPending
                ...
                : data?.map((comment) => (
                    <div key={comment.id}>
                          ...
                          <div className="flex items-center">
                            <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
                              <img
                                ...
                                src={comment.user?.profile_pic ? `/uploads/profiles/${comment.user.profile_pic}` : '/default/default_profile.png'}
                      ...
                      <article className="p-3 mb-2 ml-4 lg:ml-8 text-base bg-white rounded-lg dark:bg-gray-900">
                        <footer className="flex justify-between items-center mb-1">
                          <div className="flex items-center">
                            <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
                              <img
