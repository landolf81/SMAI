              ...
              <div className="absolute -top-0 left-4 right-4 z-10 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    title="즐겨찾기"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill={favSet.has(getFavKey(market.name, 'all', 'summary')) ? '#f59e0b' : 'none'} stroke={favSet.has(getFavKey(market.name, 'all', 'summary')) ? '#f59e0b' : '#9ca3af'} strokeWidth="2">
