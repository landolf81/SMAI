...
const PesticideInfo = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      {/* 헤더 */}
      <h2 className="text-lg font-bold text-gray-800 mb-1">참외 등록 농약 정보</h2>
      <p className="text-sm text-gray-500 mb-4">참외 재배에 사용 가능한 등록 농약을 검색하세요.</p>
      ...
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-sm text-gray-400">참외 등록 농약 정보가 곧 제공될 예정입니다.</p>
      </div>
    </div>
  );
};
